...
public class ExampleClient {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println(doublets.getNeighbors("tree"));

        System.out.println(doublets.isWord("tree"));
        System.out.println(doublets.isWord("abed"));
        long start = System.currentTimeMillis();
        System.out.println(doublets.getMinLadder("tree", "lava"));
